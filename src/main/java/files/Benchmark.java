...
/**
 * It represents a single operation done on the network, for instance, the computation of the behavioral space.
 * Each Benchmark consists of:
 * - the date when the task has been performed
 * - the description of the task
 * - the duration of the task expressed in nanoseconds (use System.nanoTime() to record the current time in ns).
 */
